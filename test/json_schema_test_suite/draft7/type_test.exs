defmodule JsonSchemaTestSuite.Draft7.TypeTest do
  ...
  describe ~s|object type matches objects| do
    setup do
      %{schema: JsonXema.new(%{"type" => "object"})}
    end
  ...
  describe ~s|array type matches arrays| do
    setup do
      %{schema: JsonXema.new(%{"type" => "array"})}
    end
  ...
  describe ~s|boolean type matches booleans| do
    setup do
      %{schema: JsonXema.new(%{"type" => "boolean"})}
    end
  ...
  describe ~s|multiple types can be specified in an array| do
    setup do
      %{schema: JsonXema.new(%{"type" => ["integer", "string"]})}
    end
  ...
  describe ~s|type: array or object| do
    setup do
      %{schema: JsonXema.new(%{"type" => ["array", "object"]})}
    end
  ...
  describe ~s|type: array, object or null| do
    setup do
      %{schema: JsonXema.new(%{"type" => ["array", "object", "null"]})}
    end
