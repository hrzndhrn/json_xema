defmodule Draft6.Optional.BignumTest do
  ...
  describe "integer comparison (1)" do
    setup do
      %{schema: JsonXema.new(~s( {"maximum":18446744073709551615} ))}
    end
  ...
  describe "float comparison with high precision" do
    setup do
      %{schema: JsonXema.new(~s( {"exclusiveMaximum":9.727837981879871e26} ))}
    end
  ...
  describe "integer comparison (2)" do
    setup do
      %{schema: JsonXema.new(~s( {"minimum":-18446744073709551615} ))}
    end
  ...
  describe "float comparison with high precision on negative numbers" do
    setup do
      %{schema: JsonXema.new(~s( {"exclusiveMinimum":-9.727837981879871e26} ))}
    end
